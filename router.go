...
type Router struct {
	...
	midware []func(http.ResponseWriter, *http.Request) (http.ResponseWriter, *http.Request) // 全局中间件
...
func (r *Router) AddMidware(handle func(http.ResponseWriter, *http.Request) (http.ResponseWriter, *http.Request)) *Router {
	if r.midware == nil {
		r.midware = make([]func(http.ResponseWriter, *http.Request) (http.ResponseWriter, *http.Request), 0)
	}
...
endloop:
	...
	tmpMidware := make([]func(http.ResponseWriter, *http.Request) (http.ResponseWriter, *http.Request), 0)
